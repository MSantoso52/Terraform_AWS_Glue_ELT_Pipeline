...
3. Initialize Terraform
   ...
   terraform init
   ```
   ![terraform init screenshot]([screenshot/"terraform init.png"](https://github.com/MSantoso52/Terraform_AWS_Glue_ELT_Pipeline/blob/main/screenshot/terraform%20init.png))
